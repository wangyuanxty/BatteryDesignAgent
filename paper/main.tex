...
loop traverses the whole chain of cell-design variables---material system,
...
(failures diagnosed and routed to the scale of their cause), a reachability
check that triggers material-level search only when the current
...
measures each workflow rule in turn: reachability check with
