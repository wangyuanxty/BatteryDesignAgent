...
move the yardstick it is measured against. The AI community has begun to
...
\cite{delegatedagency2026} identifies contract specification quality and
governance visibility as the design dimensions that discipline delegated
...
which the evaluator is code, the evaluation contract is pre-registered
