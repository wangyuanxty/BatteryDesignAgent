...
energy density), a smartphone (demanding volumetric target plus a strict temperature
red line plus a voltage plateau), a hybrid vehicle (high-temperature aging
plus nail penetration), and a drone (specific energy plus a mass limit).
...
An ablation variant is declared in the task text itself (``reachability
...
Three ablations are executed: \emph{reachability escalation off} (no proactive
