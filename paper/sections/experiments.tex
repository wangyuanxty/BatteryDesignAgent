...
axis. Two further legs re-execute the eight sessions under GPT-5.6 Luna
and under mimo-v2.5---foreign-vendor models served through
OpenAI-compatible APIs, same protocol, harness, task texts, and budget---so
the cross-family comparison is made outside the primary vendor at matched
tier logic.
