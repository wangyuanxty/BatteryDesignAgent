...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.85\linewidth]{figs/fig_arch_v6.png}
...
endorsement---inside which four governance mechanisms operate as fixed,
always-on rules. Figure~\ref{fig:protocol} shows the loop with its
fallback routing and the outside-agent adjudication layer.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.88\linewidth]{figs/fig_protocol_v2.png}
...
\textbf{Component 4: mechanized adjudication and the audit chain.} Unlike
