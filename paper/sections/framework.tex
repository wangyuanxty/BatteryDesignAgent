...
switch. The red-dashed evaluator delivers the code-computed verdict
...
target. If the objective exceeds the ceiling, the agent is required to
...
\end{equation}
where $\mathrm{ceiling}_c(\text{system})$ is the best target value the
