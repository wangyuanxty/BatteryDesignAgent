...
8/8 total is seed-robust. The flash, luna, mimo, and C1 columns are
...
Cross-model corroboration spans 24 further sessions over three further
models (flash, luna, mimo). The four-model matrix (8/8 under pro
and flash, $4/8$ with honest signatures
under each of two foreign-vendor models, Section~5.4) provides stability evidence across
