...
Six limitations bound the present study. (i) \emph{Replication.} Each
condition-by-task cell contains a single run; a threefold replication
covers all eight tasks (three seeds each; $24/24$ achieved under the
mechanical adjudicator with complete evidence coverage---design-level, not
trajectory-level, reproduction), and cross-model corroboration spans 24
further sessions over three models. The three-model matrix (8/8 under pro
