...
of cell-design variables (electrolyte, separator, electrode, architecture,
...
are structural, and fails the five that need material-level variables: a
...
Third, the workflow itself decomposes cleanly. Reachability escalation is
causal for the material-bottleneck tasks, and disabling it costs two of
the three outright; forced architecture exploration matters narrowly
