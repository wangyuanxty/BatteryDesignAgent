...
($+2.2\%$/$+4.5\%$/$+0.5\%$ on T1/T4/T8, Table~\ref{tab:margins}) fail
...
\begin{table}[!ht]
\centering
\caption{HOMO/LUMO levels (eV) of the four funnel-passed molecules at the
r2SCAN-3c level (ORCA) with CP2K (PBE-D3/GTH) cross-validation; drift =
per-molecule functional spread. All HOMO levels sit below the funnel's
$-6.0$ eV oxidation-stability elimination line in both codes.}
\label{tab:endorse}
\setlength{\tabcolsep}{2.5pt}
\begin{tabular}{p{3.2cm}p{1.8cm}p{1.8cm}p{1.8cm}p{1.8cm}}
\toprule
Molecule & ORCA HOMO & ORCA LUMO & CP2K HOMO & drift \\
\midrule
FEC & $-7.458$ & $-0.670$ & $-7.461$ & 0.003 \\
VC  & $-6.470$ & $-0.861$ & $-6.319$ & 0.152 \\
PS  & $-7.151$ & $+0.048$ & $-6.689$ & 0.462 \\
DTD & $-7.601$ & $-0.502$ & $-7.230$ & 0.371 \\
\bottomrule
\end{tabular}
\end{table}
