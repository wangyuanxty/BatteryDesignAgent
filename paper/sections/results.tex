...
the six columns, and Figure~\ref{fig:main} shows the same matrix as a
...
\begin{tabular}{p{0.1\linewidth} p{0.13\linewidth} p{0.13\linewidth} p{0.13\linewidth} p{0.125\linewidth} p{0.13\linewidth} p{0.13\linewidth}}
\toprule
...
observed now from the model side. One yardstick observation deserves
