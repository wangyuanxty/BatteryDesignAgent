# -*- coding: utf-8 -*-
"""Round-4 suite: 4 candidates x (1C DFN + 4C45 DFN plating + aging SPMe + calc-energy
+ nail run-tr hA=0.4248 + hot probe). Same shape as _run_r3.py."""
import json
import subprocess
import sys
import time
...
CANDIDATES = [
    ("r4_f1", "bridge/r4_f1.json"),
    ("r4_f2", "bridge/r4_f2.json"),
    ("r4_f3", "bridge/r4_f3.json"),
    ("r4_f4", "bridge/r4_f4.json"),
]
